  ...
  return (
    <DndContext onDragEnd={handleDragEnd} onDragStart={handleDragStart}>
      ...
      >
        ...
        <div 
          className="h-180 w-70 flex flex-col items-center justify-center gap-4 bg-[url(/ladder.png)] bg-size-[100%_100%]" 
        >
          ...
          <button 
            className={`absolute bg-slate-200 dark:bg-gray-800/80 bottom-2.5 border-2 p-3 rounded-xl
        ...
        >
          ...
          <div className='lg:h-40 lg:w-150 md:w-80 md:h-80 bg-gray-200 dark:bg-gray-400/80 p-4 m-4 flex flex-row flex-wrap border-2 rounded-xl shadow-md/30 gap-2 items-center justify-evenly'
          >
            {
